...
class HomeScreen extends StatelessWidget {
  ...
  void _showAbout(BuildContext context) => showModalBottomSheet<void>(
        context: context,
        showDragHandle: true,
        builder: (context) => SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                const Text('FetchTube', style: kWordmarkStyle),
                ...
                _AboutRow('Saved to', 'Download/FetchTube'),
                FutureBuilder<String>(
                  future: ytDlpVersion(),
                  builder: (context, snap) => _AboutRow(
                    'Extractor',
                    snap.hasData ? 'yt-dlp ${snap.data}' : 'yt-dlp …',
                  ),
                ),
              ],
            ),
...
class _AboutRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Row(children: [
          Expanded(child: Text(label, style: eyebrowStyle(context))),
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Container(
              ...
              child: Icon(audio ? Icons.music_note : Icons.movie_outlined,
                  color: accent, size: 20),
            ),
            const SizedBox(height: 14),
            Text(audio ? 'Music' : 'Videos',
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Row(children: [
            Icon(Icons.download_outlined, size: 22, color: scheme.onSurfaceVariant),
